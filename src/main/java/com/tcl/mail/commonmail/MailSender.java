package com.tcl.mail.commonmail;
...
public class MailSender
{
    ...
    private Properties getProperties(EmailMsg emailMsg)
    {
        ...
        // 认证信息
        if (emailMsg.getUsername() != null && emailMsg.getPassword() != null
                && emailMsg.getUsername().length() > 0 && emailMsg.getPassword().length() > 0)
        {
            // 这样才能通过验证
     ...
     * @throws MessagingException
     */
    private void setFromEmail(EmailMsg emailMsg, MimeMessage msg) throws AddressException,
            MessagingException
    {
     ...
     * @throws MessagingException
     */
    private void setToEmail(EmailMsg emailMsg, MimeMessage msg) throws AddressException,
            MessagingException
    {
     ...
     * @throws MessagingException
     */
    private void setCcEmail(EmailMsg emailMsg, MimeMessage msg) throws AddressException,
            MessagingException
    {
     ...
     * @throws MessagingException
     */
    private void setBccEmail(EmailMsg emailMsg, MimeMessage msg) throws AddressException,
            MessagingException
    {
    ...
    private void setAttachments(EmailMsg emailMsg, MimeMultipart content)
     ...
     * @throws UnsupportedEncodingException
     */
    private void setObject(EmailMsg emailMsg, MimeMessage msg) throws MessagingException,
     ...
     * @throws MessagingException
     */
    private String getToEmailAddressesString(EmailMsg emailMsg, MimeMessage msg)
     ...
     * @throws MessagingException
     */
    private String getCcEmailAddressesString(EmailMsg emailMsg, MimeMessage msg)
            throws AddressException, MessagingException
    {
     ...
     * @throws MessagingException
     */
    private String getBccEmailAddresseslist(EmailMsg emailMsg, MimeMessage msg)
            throws AddressException, MessagingException
    {
